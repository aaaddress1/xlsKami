...
namespace Macrome
{
    public static class FormulaHelper
    {
        ...
        public static Stack<AbstractPtg> GetAlertPtgStack(string alertString)
        {
            ...
            ptgStack.Push(new PtgStr(alertString, false, AbstractPtg.PtgDataType.VALUE));
        ...
        public static List<Formula> GetCharFormulasForString(string str, int curRow, int curCol,
